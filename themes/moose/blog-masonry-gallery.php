...
if(isset($moose_elated_options['blog_masonry_gallery_content_position'])){
	$moose_elated_blog_content_position = $moose_elated_options['blog_masonry_gallery_content_position'];
}
