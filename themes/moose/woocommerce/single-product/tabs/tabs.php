...
if ( ! empty( $tabs ) ) : ?>
    ...
    <?php if(isset($moose_elated_options['woo_products_info_style']) && ($moose_elated_options['woo_products_info_style'])=="vertical_tabs"){?>
	...
	<?php }  else {?>
		<div class="eltd_accordion_holder toggle boxed woocommerce-accordion <?php if(isset($moose_elated_options['accordion_toggle_boxed_background_pattern']) && $moose_elated_options['accordion_toggle_boxed_background_pattern']!='no'){ echo "has_pattern";} ?>">
			<?php foreach ( $tabs as $key => $tab ) : ?>
