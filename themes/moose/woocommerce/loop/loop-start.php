...
<?php global $moose_elated_options;
...
if(isset($moose_elated_options['woo_products_hover_list_type'])){
    $products_hover_list_type = $moose_elated_options['woo_products_hover_list_type'];
}
$class='';
...
$disable_space = '';
if(isset($moose_elated_options['woo_products_disable_space_between_products']) && $moose_elated_options['woo_products_disable_space_between_products']=='yes'){
