...
global $product, $woocommerce_loop, $moose_elated_options;
...
if(isset($moose_elated_options['woo_products_enable_lighbox_icon'])){
	$woo_products_enable_lighbox_icon_yes_no =  $moose_elated_options['woo_products_enable_lighbox_icon'];
}

$hide_separator = "no";
if(isset($moose_elated_options['woo_products_title_separator_hide_title_separator'])){
	$hide_separator = $moose_elated_options['woo_products_title_separator_hide_title_separator'];
}
