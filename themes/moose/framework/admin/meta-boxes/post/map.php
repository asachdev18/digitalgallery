...
$eltd_custom_sidebars = moose_elated_get_custom_sidebars();
...
$eltd_hide_featured_image = new MooseElatedMetaField(
	"yesno",
	"eltd_hide-featured-image",
	"no",
	esc_html__( "Hide Featured image", 'moose' ),
	esc_html__( "Do you want to hide featured image for this post?", 'moose' )
);
$eltdGeneral->addChild(
	"eltd_hide-featured-image",
...
$eltdPostType = new MooseElatedMetaBox(
	'post',
	esc_html__( 'Post Size', 'moose' ),
...
$eltd_blog_masonry_gallery_article_size = new MooseElatedMetaField(
	'select',
	'eltd_blog_masonry_gallery_article_size',
	'square_small',
	esc_html__( 'Size', 'moose' ),
	esc_html__( 'Choose article size in blog list for blog masonry gallery template', 'moose' ),
	array(
...
$subtitle_padding_group = new MooseElatedGroup(
	esc_html__( "Padding", 'moose' ),
	esc_html__( "Define padding for subtitle (When using separator around subtitle, only right margin is counted for left/right margin)", 'moose' )
);
$eltd_page_title_area_container->addChild(
...
$eltdLinkPostFormat = new MooseElatedMetaBox(
	"post",
	esc_html__( "Link Post Format", 'moose' )
);
moose_elated_meta_boxes()->addMetaBox(
	"post-format-link",
	$eltdLinkPostFormat
...
$eltdQuotePostFormat = new MooseElatedMetaBox(
	"post",
	esc_html__( "Quote Post Format", 'moose' )
);
moose_elated_meta_boxes()->addMetaBox(
	"post-format-quote",
	$eltdQuotePostFormat
...
$quote_format = new MooseElatedMetaField(
	"text",
	"quote_format",
	"",
	esc_html__( "Quote", 'moose' ),
	esc_html__( "Enter Quote", 'moose' )
);
...
$eltdAudioPostFormat = new MooseElatedMetaBox(
	"post",
	esc_html__( "Audio Post Format", 'moose' )
);
moose_elated_meta_boxes()->addMetaBox(
	"post-format-audio",
	$eltdAudioPostFormat
...
$audio_link = new MooseElatedMetaField(
	"text",
	"audio_link",
	"",
	esc_html__( "Link", 'moose' ),
	esc_html__( "Enter audion link", 'moose' )
);
...
$eltdGalleryPostFormat = new MooseElatedMetaBox(
	"post",
	esc_html__( "Gallery Post Format", 'moose' )
);
moose_elated_meta_boxes()->addMetaBox(
	"post-format-gallery",
	$eltdGalleryPostFormat
);

$eltd_post_image_gallery = new MooseElatedMultipleImages(
	"eltd_post-image-gallery",
	esc_html__( "Gallery Images", 'moose' ),
	esc_html__( "Choose your gallery images", 'moose' )
);
$eltdGalleryPostFormat->addChild(
	"eltd_post-image-gallery",
	$eltd_post_image_gallery
);

$gallery_position = new MooseElatedMetaField(
	"select",
	"gallery_position",
	"above_post_content",
	esc_html__( "Gallery Position", 'moose' ),
	esc_html__( "Choose gallery position on single post pages", 'moose' ),
	array(
		"above_post_content" => esc_html__( "Above Post Content", 'moose' ),
		"above_post_content_and_sidebar" => esc_html__( "Above Post Content and Sidebar", 'moose' )
	)
);
$eltdGalleryPostFormat->addChild(
	"gallery_position",
...
$eltdVideoPostFormat = new MooseElatedMetaBox(
	"post",
	esc_html__( "Video Post Format", 'moose' )
);
moose_elated_meta_boxes()->addMetaBox(
	"post-format-video",
	$eltdVideoPostFormat
...
$video_format_choose = new MooseElatedMetaField(
	"select",
	"video_format_choose",
	"youtube",
	esc_html__( "Video Type", 'moose' ),
	esc_html__( "Choose video type", 'moose' ),
	array(
		"youtube" => esc_html__( "Youtube", 'moose' ),
		"vimeo" => esc_html__( "Vimeo", 'moose' ),
		"self" => esc_html__( "Self Hosted", 'moose' )
	),
	array(
		"dependence" => true,
		"hide"       => array(
...
$video_y_and_v_container = new MooseElatedContainer(
...
$video_self_hosted_container = new MooseElatedContainer(
...
$video_format_link = new MooseElatedMetaField(
	"text",
	"video_format_link",
	"",
	esc_html__( "Video ID", 'moose' ),
	esc_html__( "Enter Video ID", 'moose' )
);
...
$video_format_image = new MooseElatedMetaField(
	"image",
	"video_format_image",
	"",
	esc_html__( "Video Image", 'moose' ),
	esc_html__( "Upload video image", 'moose' )
);
...
$video_format_webm = new MooseElatedMetaField(
	"text",
	"video_format_webm",
	"",
	esc_html__( "Video webm", 'moose' ),
	esc_html__( "Enter video URL", 'moose' )
);
$video_self_hosted_container->addChild(
	"video_format_webm",
	$video_format_webm
...
$video_format_mp4 = new MooseElatedMetaField(
	"text",
	"video_format_mp4",
	"",
...
$video_format_ogv = new MooseElatedMetaField(
	"text",
	"video_format_ogv",
	"",
