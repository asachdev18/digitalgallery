...
class MooseElatedSkin extends MooseElatedSkinAbstract {
    /**
    ...
    public function __construct() {
        ...
        //hook to
        add_action('moose_elated_admin_scripts_init', array($this, 'registerStyles'));
        add_action('moose_elated_admin_scripts_init', array($this, 'registerScripts'));

        add_action('moose_elated_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('moose_elated_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('moose_elated_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('moose_elated_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            moose_elated_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            moose_elated_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    = moose_elated_get_admin_tab();
        $active_page = $moose_elated_framework->eltdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param MooseElatedAdminPage $page current page to load
     *
     * @see ElatedSkinAbstract::loadTemplatePart()
     */
