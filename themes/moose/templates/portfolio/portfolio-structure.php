...
if(get_post_meta($id, "eltd_choose-portfolio-single-view", true) != "") {
	...
	$portfolio_template = $moose_elated_options['portfolio_style'];
}
...
<div class="container" <?php moose_elated_inline_style($container_styles); ?>>
	<?php if($moose_elated_options['overlapping_content'] == 'yes') {?>
		<div class="overlapping_content"><div class="overlapping_content_inner">
	<?php } ?>
	<div class="container_inner default_template_holder clearfix" <?php moose_elated_inline_style($content_style); ?>>
