...
if (isset($moose_elated_options['portfolio_gallery_image_hover_style'])) {
    $portfolio_gallery_hover_type = $moose_elated_options['portfolio_gallery_image_hover_style'];
}

//gallery hover separator with text
if (isset($moose_elated_options['portfolio_gallery_image_hover_separator'])) {
    $portfolio_gallery_image_hover_separator = $moose_elated_options['portfolio_gallery_image_hover_separator'];
}
...
} elseif(isset($moose_elated_options['portfolio_columns_number']) && $moose_elated_options['portfolio_columns_number'] !== '') {
	$columns_number = 'v'.$moose_elated_options['portfolio_columns_number'];
}
    ...
    if (is_array($portfolio_images) && count($portfolio_images)){
		foreach($portfolio_images as $portfolio_image){
			...
			<?php if($portfolio_image['portfolioimg'] != ""){ ?>
                ...
                $single_image_id = moose_elated_get_attachment_id_from_url($portfolio_image['portfolioimg']);
