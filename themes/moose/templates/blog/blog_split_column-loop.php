...
if (isset($moose_elated_options['blog_split_column_show_categories'])){
	$blog_show_categories = $moose_elated_options['blog_split_column_show_categories'];
}

$blog_show_comments = "no";
if (isset($moose_elated_options['blog_split_column_show_comments'])){
	$blog_show_comments = $moose_elated_options['blog_split_column_show_comments'];
}

$blog_show_author = "yes";
if (isset($moose_elated_options['blog_split_column_show_author'])){
	$blog_show_author = $moose_elated_options['blog_split_column_show_author'];
}
$blog_show_like = "no";
if (isset($moose_elated_options['blog_split_column_show_like'])) {
	$blog_show_like = $moose_elated_options['blog_split_column_show_like'];
}

$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (isset($moose_elated_options['blog_split_column_show_ql_mark'])) {
	$blog_show_ql_icon_mark = $moose_elated_options['blog_split_column_show_ql_mark'];
}
...
$blog_show_date = "yes";
if (isset($moose_elated_options['blog_split_column_show_date'])) {
	$blog_show_date = $moose_elated_options['blog_split_column_show_date'];
}

$blog_social_share_type = "dropdown";
if(isset($moose_elated_options['blog_split_column_select_share_option'])){
	$blog_social_share_type = $moose_elated_options['blog_split_column_select_share_option'];
}
...
if (isset($moose_elated_options['enable_social_share'])&& $moose_elated_options['enable_social_share'] =="yes"){
	if (isset($moose_elated_options['post_types_names_post'])&& $moose_elated_options['post_types_names_post'] =="post"){
		if (isset($moose_elated_options['blog_split_column_show_share']) && $blog_social_share_type == "dropdown") {
			$blog_show_social_share = $moose_elated_options['blog_split_column_show_share'];
		}
	}
}

$blog_read_more_button_classes = 'transparent ';
if (isset($moose_elated_options['blog_split_column_read_more_button_icon']) && $moose_elated_options['blog_split_column_read_more_button_icon'] == 'yes'){
...
if( isset($moose_elated_options['blog_split_column_image_size']) && $moose_elated_options['blog_split_column_image_size'] !== '') {
    $blog_image_size = 'eltd-moose-'.$moose_elated_options['blog_split_column_image_size'];

}

if( $blog_image_size == 'custom'
    && isset($moose_elated_options['blog_split_column_image_size_height']) && $moose_elated_options['blog_split_column_image_size_height'] !== ''
    && isset($moose_elated_options['blog_split_column_image_size_width']) && $moose_elated_options['blog_split_column_image_size_width'] !== '') {

    $image_height = $moose_elated_options['blog_split_column_image_size_height'];
    $image_width = $moose_elated_options['blog_split_column_image_size_width'];
					...
					<div class="post_text">
						<div class="post_text_inner">
							...
							<?php if($blog_show_author == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_like == "yes") { ?>
								<div class="post_info">
									<?php moose_elated_post_info(array('author' => $blog_show_author, 'share' => $blog_show_social_share, 'category' => $blog_show_categories, 'like' => $blog_show_like)); ?>
								</div>
							<?php } ?>
							<?php
								moose_elated_excerpt();
                                moose_elated_read_more_button('blog_split_column_read_more_button',$blog_read_more_button_classes);
							?>
							<?php if(isset($moose_elated_options['blog_split_column_show_share']) && $moose_elated_options['blog_split_column_show_share'] == "yes" && $blog_social_share_type == "list") {
