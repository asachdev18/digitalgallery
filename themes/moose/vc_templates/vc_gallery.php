...
//		$slides_wrap_end = '</ul>';
	...
	if ($frame == 'use_frame') {
		...
		if ($choose_frame == "frame2") {
			$output .= '<img src="' . get_template_directory_uri() . '/img/slider_frame-2.png" alt="' . esc_attr__( 'slider-frame-image', 'moose' ) . '" />';
		} elseif ($choose_frame == "frame3") {
			$output .= '<img src="' . get_template_directory_uri() . '/img/slider_frame-3.png" alt="' . esc_attr__( 'slider-frame-image', 'moose' ) . '" />';
		} elseif ($choose_frame == "frame4") {
			$output .= '<img src="' . get_template_directory_uri() . '/img/slider_frame-4.png" alt="' . esc_attr__( 'slider-frame-image', 'moose' ) . '" />';
		} else {
			$output .= '<img src="' . get_template_directory_uri() . '/img/slider_frame.png" alt="' . esc_attr__( 'slider-frame-image', 'moose' ) . '" />';
		}
		$output .= "</div>";
	}
