...
$html .= '<div class="vertical_split_slider_preloader" '.$eltd_preloader_style.'><div class="ajax_loader"><div class="ajax_loader_1">'.moose_elated_loading_spinners(true).'</div></div></div>';
