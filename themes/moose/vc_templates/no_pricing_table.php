...
$args = array_merge($args, $moose_elated_icon_collections->getShortcodeParams(),$pricing_table_icons_form_fields);
...
if($type=="price_on_top" ){
    $html .= "<li class='prices' " . moose_elated_get_inline_style($price_background_style) . ">";
    $html .= "<div class='price_in_table'" .  moose_elated_get_inline_style($price_border_style).">";
    $html .= "<sup class='value' ".moose_elated_get_inline_style($price_currency_style).">".$currency."</sup>";
    $html .= "<span class='price' ".moose_elated_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/".$price_period."</span>";
    $html .= "</div>"; // close div.price_in_table
    $html .= "</li>"; //close li.prices
    $html .= "<li class='cell table_title ".$title_clasess."' ".moose_elated_get_inline_style($title_holder_style)."><span class='title_content' ".$title_style.">".$title."</span>";
    if($title_separator == "yes"){
...
if($type=="title_on_top"){	
    $html .= "<li class='cell table_title ".$title_clasess."' ".moose_elated_get_inline_style($title_holder_style).">";
    $html .= "<span class='title_content' ".$title_top_type_title_style.">".$title."</span>";
    $html .= "</li>";    

    $html .= "<li class='prices $pricing_content_clasess' ".moose_elated_get_inline_style($title_holder_style).">";
    $html .= "<div class='price_in_table'" .  moose_elated_get_inline_style($price_border_style).">";
    $html .= "<sup class='value' ".moose_elated_get_inline_style($price_currency_style).">".$currency."</sup>";
    $html .= "<span class='price' ".moose_elated_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";
