...
$moose_elated_blog_content_position = "content_above_blog_list";
if(isset($moose_elated_options['blog_standard_type_content_position'])){
	$moose_elated_blog_content_position = $moose_elated_options['blog_standard_type_content_position'];
}

$moose_elated_sidebar = get_post_meta($moose_elated_page_id, "eltd_show-sidebar", true);
...
if(isset($moose_elated_options['blog_standard_type_number_of_chars']) && $moose_elated_options['blog_standard_type_number_of_chars'] != "") {
    moose_elated_set_blog_word_count(esc_attr($moose_elated_options['blog_standard_type_number_of_chars']));
}
    ...
    <div class="container" <?php moose_elated_inline_style($moose_elated_background_color); ?>>
        ...
        <div class="container_inner default_template_holder" <?php moose_elated_inline_style($moose_elated_content_style); ?>>
            ...
            <?php elseif($moose_elated_sidebar == "1" || $moose_elated_sidebar == "2"): ?>
				<?php
					if($moose_elated_blog_content_position != "content_above_blog_list"){
						the_content();
					}
				?>
