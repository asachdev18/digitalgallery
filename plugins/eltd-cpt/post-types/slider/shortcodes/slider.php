...
class Slider implements Lib\ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        if ($slider != "") {
            ...
            if ($slider_parallax == 'no' || (isset($moose_elated_options['paspartu']) && $moose_elated_options['paspartu'] == 'yes' && (isset($moose_elated_options['paspartu_on_top']) && $moose_elated_options['paspartu_on_top'] == 'yes' && $moose_elated_options['paspartu_on_top_fixed'] == 'no'))) {
            ...
            if (isset($slider_meta['slider_thumbs'])) {
                ...
                if(isset($moose_elated_options['vertical_area']) && $moose_elated_options['vertical_area'] =='yes' && isset($moose_elated_options['paspartu']) && $moose_elated_options['paspartu'] == 'yes') {
                    $slider_thumbs = 'no';
                }
            }
            ...
            if (isset($moose_elated_options['header_background_transparency_initial']) && $moose_elated_options['header_background_transparency_initial'] != "1" && $moose_elated_options['header_background_transparency_initial'] != "") {
            ...
            if (isset($moose_elated_options['navigation_button_height']) && $moose_elated_options['navigation_button_height'] != '') {
                $arrow_button_height = esc_attr($moose_elated_options['navigation_button_height']);
            }

            if (!empty($moose_elated_options['header_height'])) {
                $header_height = esc_attr($moose_elated_options['header_height']);
            } else {
                $header_height = 110;
            }
            if ($moose_elated_options['header_bottom_appearance'] == 'stick menu_bottom') {
                $menu_bottom = '46';
            ...
            $header_top = 0;
            if (isset($moose_elated_options['header_top_area']) && $moose_elated_options['header_top_area'] == "yes"){
                if(isset($moose_elated_options['header_top_height']) && $moose_elated_options['header_top_height'] !== ""){
                    $header_top = $moose_elated_options['header_top_height'];
                } else {
                    $header_top = 36;
                }
            }
            ...
            if (isset($moose_elated_options['enable_header_top_border']) && $moose_elated_options['enable_header_top_border'] == 'yes' && isset($moose_elated_options['header_top_border_width']) && $moose_elated_options['header_top_border_width'] !== '') {
                $header_top_border = esc_attr($moose_elated_options['header_top_border_width']);
            }
            if (isset($moose_elated_options['enable_header_bottom_border']) && $moose_elated_options['enable_header_bottom_border'] == 'yes' && isset($moose_elated_options['header_bottom_border_width']) && $moose_elated_options['header_bottom_border_width'] !== '') {
                $header_bottom_border = esc_attr($moose_elated_options['header_bottom_border_width']);
            }
            ...
            if (isset($moose_elated_options['enable_manu_item_border']) && $moose_elated_options['enable_manu_item_border'] == 'yes' && isset($moose_elated_options['menu_item_style']) && $moose_elated_options['menu_item_style'] == 'large_item') {
                if (isset($moose_elated_options['menu_item_border_style']) && $moose_elated_options['menu_item_border_style'] == 'all_borders') {
                    $large_menu_item_border = esc_attr($moose_elated_options['menu_item_border_width']) * 2;
                }
                if (isset($moose_elated_options['menu_item_border_style']) && $moose_elated_options['menu_item_border_style'] == 'top_bottom_borders') {
                    $large_menu_item_border = esc_attr($moose_elated_options['menu_item_border_width']) * 2;
                }
                if (isset($moose_elated_options['menu_item_border_style']) && $moose_elated_options['menu_item_border_style'] == 'bottom_border') {
                    $large_menu_item_border = esc_attr($moose_elated_options['menu_item_border_width']);
                }
            }
            ...
            if (isset($moose_elated_options['header_bottom_appearance'])) {
                switch ($moose_elated_options['header_bottom_appearance']) {
                    case 'stick':
                        $logo_height = esc_attr($moose_elated_options['logo_height']) / 2;
                        break;
                    ...
                    case 'fixed_hiding':
                        ...
                        break;
                    case 'regular':
                    	if (isset($moose_elated_options['center_logo_image']) && $moose_elated_options['center_logo_image'] == "yes"){
                        	$logo_height = esc_attr($moose_elated_options['logo_height']) / 2;
                    	}
                    	else {
                        	$logo_height = esc_attr($moose_elated_options['logo_height']);
                    	}
                    	break;
                    default:
                        $logo_height = esc_attr($moose_elated_options['logo_height']);
            ...
            if ((get_post_meta($page_id, "eltd_header_color_transparency_per_page", true) !== "0") && ($moose_elated_options['header_background_transparency_initial'] !== "0") && ((isset($moose_elated_options['paspartu']) && $moose_elated_options['paspartu'] == 'no') || (isset($moose_elated_options['paspartu_on_top']) && $moose_elated_options['paspartu_on_top'] == 'no')) && !$hide_sticky_header) {

                $header_height_padding = $header_height + $menu_bottom + $header_top;
                if ((isset($moose_elated_options['center_logo_image']) && $moose_elated_options['center_logo_image'] == "yes" && $moose_elated_options['header_bottom_appearance'] !== 'stick menu_bottom' && $moose_elated_options['header_bottom_appearance'] !== 'stick_with_left_right_menu') || $moose_elated_options['header_bottom_appearance'] == "fixed_hiding") {
            ...
            $custom_cursor = "";
            if(isset($moose_elated_options['qs_enable_navigation_custom_cursor']) && ($moose_elated_options['qs_enable_navigation_custom_cursor']=="yes")){
                $custom_cursor = "has_custom_cursor";
            }

            if((isset($moose_elated_options['paspartu']) && $moose_elated_options['paspartu'] == 'yes' && (isset($moose_elated_options['paspartu_on_top']) && $moose_elated_options['paspartu_on_top'] == 'yes' && $moose_elated_options['paspartu_on_top_fixed'] == 'no')) || $slider_parallax == "no"){
            ...
            if($moose_elated_options['loading_animation'] == "on") {
                if($moose_elated_options['loading_image'] != "") {
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1"><div class="ajax_loader_2"><img src="' . esc_url($moose_elated_options['loading_image']) . '" alt="" /></div></div></div>';
                }else{
                    $ajax_loader = '<div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . moose_elated_loading_spinners(true) . '</div></div>';
                }
            }

            $html .= '<div id="eltd-' . esc_attr($slider) . '" ' . $anchor_data . ' ' . $responsiveness_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr($animation_type_class . ' ' . $custom_cursor . ' ' . $full_screen_class . ' ' . $responsive_height_class . ' ' . $height_class . ' ' . $auto_start_class . ' ' . $header_effect_class . ' ' . $slider_numbers_class .  ' ' . $slider_thumbs_class . ' ' . $slider_transparency_class . ' ' . $navigation_position_class . ' ' . $content_next_to_arrows_class) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' '.moose_elated_get_inline_style($slide_holder_height. $background_color).'><div class="eltd_slider_preloader" '.moose_elated_get_inline_style($background_color).'>'.$ajax_loader.'</div>';
            $html .= '<div class="carousel-inner ' . esc_attr($slider_css_position_class) . '" '.moose_elated_get_inline_style($carouselinner_height).' '.$data_parallax_transform.'>';
            query_posts($args);
            ...
            if (have_posts()) : $postCount = 0;
                while (have_posts()) : the_post();
                    ...
                    $thumbnail_attributes = moose_elated_get_attachment_meta_from_url($thumbnail, array('width','height'));
                    ...
                    if (get_post_meta(get_the_ID(), 'eltd_slide-title-background-color', true) !== '') {
                        ...
                        $slide_title_span_style .= 'background-color: ' . esc_attr(moose_elated_rgba_color($slide_title_bg_color, $slide_title_bg_transparency)) . ';';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') {
                        ...
                        if ($slide_separator_type_var == "without_icon") {
                            ...
                            if ($slide_separator_color !== '') {
                                ...
                                if ($slide_separator_transparency !== '') {
                                    ...
                                    $slide_separator_rgba_color = moose_elated_rgba_color($slide_separator_color, $slide_separator_transparency);
                        ...
                        if (get_post_meta(get_the_ID(), "eltd_slide_title_separator_type", true) == "with_icon") {
                            ...
                            if (get_post_meta(get_the_ID(), "eltd_slide_title_separator_with_icon_icon_pack", true) != ''){
                                ...
                                $slide_separator_icon_param = $moose_elated_icon_collections->getIconCollection($slide_separator_icon);
                    ...
                    if (get_post_meta(get_the_ID(), 'eltd_slide-subtitle-background-color', true) !== '') {
                        ...
                        $slide_subtitle_span_style .= 'background-color: ' . esc_attr(moose_elated_rgba_color($slide_subtitle_bg_color, $slide_subtitle_bg_transparency)) . ';';
                    }
                    ...
                    if ($slide_text_separator_var == "no") {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide-text-background-color', true) !== '') {
                            ...
                            $slide_text_span_style .= 'background-color: ' . esc_attr(moose_elated_rgba_color($slide_text_bg_color, $slide_text_bg_transparency)) . ';';
                        }
                    ...
                    if ($slide_type == 'video') {
                        ...
                        $html .= '<div class="video"><div class="mobile-video-image" '.moose_elated_get_inline_style('background-image: url(' . esc_url($video_image) . ')').'></div><div class="video-overlay';
                        ...
                        $html .= '<div class="image" '.moose_elated_get_inline_style('background-image:url(' . esc_url($image) . ')').'>';
                        if ($slider_thumbs == 'no') {
                            $html .= '<img src="' . esc_url($image) . '" alt="' . esc_attr($title) . '">';
                        }

                        if ($image_overlay_pattern !== "") {
                            $html .= '<div class="image_pattern" '.moose_elated_get_inline_style('background: url(' . esc_url($image_overlay_pattern) . ') repeat 0 0').'></div>';
                        }
                        $html .= '</div>';
                    }
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-subtitle", true) != "") {
                        ...
                        $html_text .= '<h3 class="eltd_slide_subtitle" '.moose_elated_get_inline_style($slide_subtitle_style).'>';
						if ($slide_subtitle_separator_style !== '' && ($slide_subtitle_separator_position == 'both' || $slide_subtitle_separator_position == 'left')){
							$html_text .= '<span class="separator" '.moose_elated_get_inline_style($slide_subtitle_separator_style.' '.$subtitle_left_sep_margin).' ></span>';
						}
						$html_text .= '<span '.moose_elated_get_inline_style($slide_subtitle_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), 'eltd_slide-subtitle', true)) . '</span>';
						if ($slide_subtitle_separator_style !== '' && ($slide_subtitle_separator_position == 'both' || $slide_subtitle_separator_position == 'right')){
							$html_text .= '<span class="separator" '.moose_elated_get_inline_style($slide_subtitle_separator_style.' '.$subtitle_right_sep_margin).' ></span>';
						}
                        $html_text .= '</h3>';
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ((get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'bottom' ) && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.moose_elated_get_inline_style($slide_separator_styles.$slide_top_separator_styles).' class="separator separator_top"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-hide-title", true) != true) {
                        ...
                        $html_text .= '<h2 class="eltd_slide_title" '.moose_elated_get_inline_style($slide_title_style).'>';
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.moose_elated_get_inline_style($slide_separator_styles.$slide_left_separator_margin).' class="separator separator_left"><span class="slide_separator_dots" '.moose_elated_get_inline_style($slide_dots_style).'></span></span>';
                        }
                        if (get_post_meta(get_the_ID(), "eltd_slide-title-link", true) != '') {
                            $html_text .= '<a '.moose_elated_get_inline_style($slide_title_style).' '.$slide_title_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-title-link", true)) . '" target="' . esc_attr(get_post_meta(get_the_ID(), "eltd_slide-title-target", true)) . '">';
                        }
                        $html_text .= '<span '.moose_elated_get_inline_style($slide_title_span_style).'>' . wp_kses_post(get_the_title()) . '</span>';
                        if (get_post_meta(get_the_ID(), "eltd_slide-title-link", true) != '') {
                            $html_text .= '</a>';
                        }
                        if ($slide_separator_position == 'left_right') {
                            $html_text .= '<span '.moose_elated_get_inline_style($slide_separator_styles.$slide_right_separator_margin).' class="separator separator_right"><span class="slide_separator_dots" '.moose_elated_get_inline_style($slide_dots_style).'></span></span>';
                        }
                    ...
                    if ((get_post_meta(get_the_ID(), "eltd_slide-separator-title", true) == 'yes') && ($slide_separator_position != 'top') && ($slide_separator_position) != 'left_right') {
                        ...
                        if (get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_icon' && get_post_meta(get_the_ID(), 'eltd_slide_title_separator_type', true) !== 'with_custom_icon') {
                            ...
                            $html_text .= '<div '.moose_elated_get_inline_style($slide_separator_styles.$slide_bottom_separator_styles).'  class="separator separator_bottom"></div>';
                            $html_text .= '</div></div>';
                        }
                        else {
                            $html_text .= '<div class="el">';
                    ...
                    if (get_post_meta(get_the_ID(), "eltd_slide-text", true) != "") {
                        ...
                        if ($slide_text_separator_var == 'yes') {
                            ...
                            $html_text .= '<h3 class="eltd_slide_text" '.moose_elated_get_inline_style($slide_text_style).'><span '.moose_elated_get_inline_style($slide_text_span_style).'>' . wp_kses_post(get_post_meta(get_the_ID(), "eltd_slide-text", true)) . '</span></h3>';
                        }
                        $html_text .= '</div></div>';
                    }
                    ...
                    if ($is_first_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button1_icon_pack', true) !== 'no_icon') {
                            $first_btn_icon_collection = $moose_elated_icon_collections->getIconCollection(get_post_meta(get_the_ID(), 'button1_icon_pack', true));
                        ...
                        $html_text .= '<a class="qbutton '.esc_attr($first_button_icon_class) . esc_attr($first_button_class).'" ' . $data_attr1 . ' '.moose_elated_get_inline_style($button_text_style1).' '.$slide_button_1_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-button-link", true)) . '" target="' . esc_attr($slide_button_target) . '"><span class="text_holder"><span class="a_overlay"></span><span>' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label", true)) . '</span><span class="hidden_text">' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label", true)) . '</span></span><span class="icon_holder" '.moose_elated_get_inline_style($icon_span_border1).'><span>' . $first_button_icon_html . '</span><span class="hidden_icon">' . $first_button_icon_html . '</span></span></a>';
                    }
                    ...
                    if ($is_second_button_shown) {
                        ...
                        if(get_post_meta(get_the_ID(), 'button2_icon_pack', true) !== 'no_icon') {
                            $second_btn_icon_collection = $moose_elated_icon_collections->getIconCollection(get_post_meta(get_the_ID(), 'button2_icon_pack', true));
						...
						$html_text .= '<a class="qbutton '.esc_attr($second_button_icon_class) . esc_attr($second_button_class).'" ' . $data_attr2 . ' '.moose_elated_get_inline_style($button_text_style2).' '.$slide_button_2_data.' href="' . esc_url(get_post_meta(get_the_ID(), "eltd_slide-button-link2", true)) . '" target="' . esc_attr($slide_button_target2) . '"><span class="text_holder"><span class="a_overlay"></span><span>' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label2", true)) . '</span><span class="hidden_text">' . esc_html(get_post_meta(get_the_ID(), "eltd_slide-button-label2", true)) . '</span></span><span class="icon_holder" '.moose_elated_get_inline_style($icon_span_border2).'><span>' . $second_button_icon_html . '</span><span class="hidden_icon">' . $second_button_icon_html . '</span></span></a>';
                    }
                    ...
                    if ($separate_text_graphic != 'yes') {
                        $html .= '<div class="slider_content ' . esc_attr($content_alignment) .'" '.moose_elated_get_inline_style($content_width . $content_xaxis . $content_yaxis_start).' '.$slide_data_start.' '.$slide_data_end.' '.$slide_data_content_resize.'>';
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner ' . esc_attr($content_animation . ' ' . $content_animation_direction) .'" '.moose_elated_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							$html .= $html_text;
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
                        ...
                        $html .= '<div class="slider_content graphic_content ' . esc_attr($graphic_alignment) . '" '.moose_elated_get_inline_style($graphic_width . $graphic_xaxis . $graphic_yaxis_start).'>';
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
								$html .= '<div class="slider_content_inner" '.moose_elated_get_inline_style($vertical_content_width . $vertical_content_xaxis . $slide_content_inner_shaddow . $slide_content_inner_background).'>';
							}
							$html .= $html_thumb;
							if(get_post_meta(get_the_ID(), "eltd_slide-content-vertical-middle", true) == "yes"){
								$html .= '</div>';
            ...
            if ($found_slides > 1) {
                if ($show_navigation_circles == "yes") {
                    ...
                    $triangle_bkg='';
                    if(isset($moose_elated_options['enable_slider_triangle']) && $moose_elated_options['enable_slider_triangle'] == 'yes') {
                ...
                if ($show_navigation_arrows == "yes") {
                    ...
                    if (isset($moose_elated_options['navigation_arrows_type']) && $moose_elated_options['navigation_arrows_type'] != '') {
                        $icon_navigation_class = $moose_elated_options['navigation_arrows_type'];
                    }
            ...
            $html .= '</div>';
            if($moose_elated_options['paspartu'] == 'yes' && $moose_elated_options['paspartu_on_bottom_slider'] == 'yes') {
