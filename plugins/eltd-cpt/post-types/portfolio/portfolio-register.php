...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $moose_elated_framework, $moose_elated_options;
        ...
        if(elated_cpt_theme_installed()) {
            $menuPosition = $moose_elated_framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $moose_elated_framework->getSkin()->getMenuIcon('portfolio');

            if(isset($moose_elated_options['portfolio_single_slug'])) {
                if($moose_elated_options['portfolio_single_slug'] != ""){
                    $slug = $moose_elated_options['portfolio_single_slug'];
                }
            }
        }
